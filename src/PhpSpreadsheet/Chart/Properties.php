...
abstract class Properties
{
     ...
     * @return $this
     */
    protected function setShadowPresetsProperties($shadow_presets)
    {
     ...
     * @return $this
     */
    protected function setShadowProperiesMapValues(array $properties_map, &$reference = null)
    {
